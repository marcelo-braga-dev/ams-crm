        ...
        <>
            ...
            <div className="row">
                <div className="col-3 mb-4">
                    <TextField  label="Atendente" fullWidth defaultValue={data?.atendente}
                                onChange={e => setData('atendente', e.target.value)}/>
                </div>
            </div>
            <div className="row">
                <div className="col-md-3 mb-4">
                    <TextField label={data?.pessoa === 'Jurídica' ? 'Data Abertura da Empresa' : 'Data Nascimento'} id="nascimento" required={required} defaultValue={data?.nascimento}
