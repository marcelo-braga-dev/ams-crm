...
export default function DadosPedido({dados}) {
    return (<>
        ...
        {dados.preco.preco_custo_convertido &&
            <Typography><b>Preço de Custo:</b> R$ {dados.preco.preco_custo_convertido}</Typography>}
        {dados.pedido.forma_pagamento &&
            <Typography><b>Forma Pagamento:</b> {dados.pedido.forma_pagamento}</Typography>}
