    ...
    return (<>
        <div className="row">
            ...
            <div className="col mb-2">
                ...
                {dados.dados.capital_social && <span className="d-block"><b>Capital Social:</b> {dados.dados.capital_social}</span>}
                ...
                {dados.dados.atividade_principal && <span className="d-block"><b>Atividade Principal:</b> {dados.dados.atividade_principal}</span>}
                {dados.dados.natureza_juridica && <span className="d-block"><b>Natureza Jurídica:</b> {dados.dados.natureza_juridica}</span>}
                {dados.dados.quadro_societario && <span className="d-block"><b>Quadro Societário:</b> {dados.dados.quadro_societario}</span>}
                {dados.dados.data_situacao && <span className="d-block"><b>Data Situação:</b> {dados.dados.data_situacao}</span>}
                {dados.dados.data_abertura && <span className="d-block"><b>Data Abertura:</b> {dados.dados.data_abertura}</span>}
