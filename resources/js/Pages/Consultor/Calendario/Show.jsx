...
export default function ({dados, destinatarios, status}) {
    function alterarStatus(status) {
        router.post(route('consultor.calendario.alterar-status', {id: dados.id, status: status}))
    }

    const deletar = () => {
        router.post(route('consultor.calendario.agenda.destroy', dados.id), {_method: 'DELETE'})
    }
            ...
            <div className="card card-body mb-4">
                <div className="row">
                    ...
                    <div className="col text-end">
                        {/*<DeleteOutlineOutlinedIcon className="cursor-pointer" color="error" data-bs-toggle="modal" data-bs-target="#modalExcluir"/>*/}
                    </div>
                </div>
                <div className="row">
                    <div className="col">
