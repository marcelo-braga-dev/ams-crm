...
export default function Register() {
    ...
    return (<Layout titlePage="Cadastrar Integrador" button={true} url={route('consultor.integradores.index')}
                    textButton={'Voltar'}>
        ...
        <div className="container bg-white px-lg-6 py-lg-5 rounded">
            ...
            <form onSubmit={submit}>
                <Typography component="h5">Cadastro de Integrador</Typography>
