    ...
    return (<Layout titlePage="Consultores">
        ...
        <Container fluid="lg" className="bg-white px-lg-6 py-lg-5 rounded">
            <Row className={"mb-3 text-right"}>
                <Col><Button color={"warning"} href={route('supervisor.consultores.create')}>Cadastrar Consultor</Button></Col>
            </Row>
            <Table hover responsive>
                ...
                {consultores.map((colsultor) => {
                    ...
                    <tr key={colsultor.id} className={"align-middle"}>
                        ...
                        <td>
                            <Button color={"primary"} href={route('supervisor.consultores.show', colsultor.id)} size="sm">Ver</Button>
                        </td>
                    </tr>)
                })}
                </tbody>
