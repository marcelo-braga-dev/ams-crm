...
export default function Register() {
    ...
    const submit = (e) => {
        ...
        post(route('supervisor.usuarios.consultores.store'));
    };

    return  (<Layout titlePage="Cadastrar Consultor" button={true} url={route('supervisor.usuarios.usuario.index')} textButton={'Voltar'}>
