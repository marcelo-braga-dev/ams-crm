                ...
                <form onSubmit={onSubmit}>
                    <div className="row">
                        ...
                        <div className="col">
                            <FormControl>
                                <RadioGroup
                                    row aria-labelledby="pessoa" defaultValue={data.pessoa} name="row-radio-buttons-group"
                    ...
                    <div className="row">
                        {data.pessoa === 'Pessoa Física' && (
                            <div className="col mb-4">
                                <TextField label={'RG'} fullWidth className="rg" onBlur={e => setData('rg', e.target.value)}/>
                            </div>
                        )}
                        {data.pessoa === 'Pessoa Física' && (
                            <div className="col mb-4">
                                <TextField label={'CPF'} fullWidth className="cpf" onBlur={e => setData('cpf', e.target.value)}/>
                            </div>
                        )}
                        {data.pessoa === 'Jurídica' && (
                            <div className="col mb-4">
                                <TextField label={'CNPJ'} fullWidth className="cnpj" onBlur={e => setData('cnpj', e.target.value)}/>
                            </div>
                        )}
                        {data.pessoa === 'Jurídica' && (
                            <div className="col mb-4">
                                <TextField label={'Inscrição Estadual'} fullWidth onBlur={e => setData('inscricao_estadual', e.target.value)}/>
                            </div>
                        )}
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="mb-4 col-12 col-md-10">
                            <TextField label="Rua/Av." fullWidth InputLabelProps={{shrink: true}} id="rua"
                                       onChange={e => setData('endereco', {...data.endereco, rua: e.target.value})}/>
                        </div>
                        <div className="mb-4 col-6 col-md-2">
                            <TextField label="Número" fullWidth InputLabelProps={{shrink: true}}
                                       onChange={e => setData('endereco', {...data.endereco, numero: e.target.value})}/>
                        </div>
                        <div className="mb-4 col-6 col-md-4">
                            <TextField label="Complemento" fullWidth InputLabelProps={{shrink: true}}
                        ...
                        <div className="mb-4 col-12 col-md-6">
                            <TextField label="Bairro" fullWidth InputLabelProps={{shrink: true}} id="bairro"
                                       onChange={e => setData('endereco', {...data.endereco, bairro: e.target.value})}/>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col mb-4">
                            <TextField label="Cidade" fullWidth id="cidade" InputLabelProps={{shrink: true}}
                                       onChange={e => setData('cidade', e.target.value)}/>
                        </div>
                        <div className="col mb-4">
                            <TextField label="Estado" fullWidth id="estado" InputLabelProps={{shrink: true}}
