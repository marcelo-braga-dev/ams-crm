    ...
    return (
        <Card sx={{margin: 1}}>
                ...
                action={
                    <div>
                        ...
                        <Menu
                            ...
                            <Link href={route('admin.chamado.show', dados.id)} underline="none" color="inherit">
            ...
            <div className="row justify-content-between px-3">
                ...
                <div className="col-auto">
                    <a href={route('admin.chamado.edit', dados.id)} className="btn btn-primary btn-sm p-1 px-3">
