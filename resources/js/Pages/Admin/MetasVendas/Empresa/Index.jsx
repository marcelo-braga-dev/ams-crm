...
export default function ({meta, mes, ano, metasMensais, vendasMensais, setores, setor}) {
    ...
    return (
        <Layout container titlePage="Editar Meta de Vendas da Empresa" menu="menu-meta-vendas"
                submenu="meta-vendas-empresa" voltar={route('admin.metas-vendas.consultores.index')}>
