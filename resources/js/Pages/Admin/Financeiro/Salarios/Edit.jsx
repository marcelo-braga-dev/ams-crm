...
export default function ({dados, userId, ano}) {
    ...
    return (
        <Layout titlePage="Salários" menu="financeiro" submenu="financeiro-salarios" empty>
            <div className="card card-body mb-4 border py-4">
                <div className="row">
                    <div className="col-2">
                        <TextField label="Ano" select fullWidth defaultValue={ano} //value={periodoAno ?? ''}
            ...
            {meses.map(item =>
                <div key={item.mes} className="card card-body mb-4 border">
