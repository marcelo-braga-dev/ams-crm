...
namespace App\Http\Controllers\Supervisor\Usuarios\Consultor;
...
class ConsultoresController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Usuarios/Consultores/Index', compact('consultores'));
    }

    public function create()
    {
        return Inertia::render('Supervisor/Usuarios/Consultores/Create');
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('Supervisor/Usuarios/Consultores/Show', compact('usuario', 'pedidos'));
    }
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Supervisor/Usuarios/Consultores/Edit', compact('usuario'));
    }
